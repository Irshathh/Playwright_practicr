...
- Location: tests\radioButton.spec.js:21:5

# Error details

```
Error: locator.isChecked: Unexpected token "" while parsing css selector "[value="radio1"". Did you mean to CSS.escape it?
Call log:
  - waiting for [value="radio1"
...
```ts
  ...
  21 | test('Radio Button', async({page})=>{
  22 | 
  23 |     await page.goto('https://rahulshettyacademy.com/AutomationPractice/');
  24 | 
  25 |     await (page.locator('[value="radio1"]')).check()
  26 |     //await page.check('[value="radio1]');
  27 | 
  28 |     await expect(page.locator('[value="radio1"]')).toBeChecked();
> 29 |     await expect(await page.locator('[value="radio1"').isChecked()).toBeTruthy();
     |                                                        ^ Error: locator.isChecked: Unexpected token "" while parsing css selector "[value="radio1"". Did you mean to CSS.escape it?
  30 | 
  31 | 
  32 | 
