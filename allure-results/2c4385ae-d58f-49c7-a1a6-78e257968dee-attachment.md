...
- Name: screenshot1.spec.js >> Auto Suggest Dropdown
- Location: tests\screenshot1.spec.js:3:1
...
Call log:
  - waiting for locator('//li[@clas]/div') to be visible
...
- generic [ref=e1]:
  ...
  - generic [ref=e12]:
    ...
    - group "Suggession Class Example" [ref=e23]:
      ...
      - textbox "Type to Select Countries" [active] [ref=e25]: ra
  ...
  - list [ref=e236]:
    - listitem [ref=e237] [cursor=pointer]:
      - generic [ref=e238]: Andorra
    - listitem [ref=e239] [cursor=pointer]:
      - generic [ref=e240]: Australia
    - listitem [ref=e241] [cursor=pointer]:
      - generic [ref=e242]: Bahrain
    - listitem [ref=e243] [cursor=pointer]:
      - generic [ref=e244]: Brazil
    - listitem [ref=e245] [cursor=pointer]:
      - generic [ref=e246]: Central African Republic
    - listitem [ref=e247] [cursor=pointer]:
      - generic [ref=e248]: Congo, the Democratic Republic of the
    - listitem [ref=e249] [cursor=pointer]:
      - generic [ref=e250]: France
    - listitem [ref=e251] [cursor=pointer]:
      - generic [ref=e252]: France Metropolitan
    - listitem [ref=e253] [cursor=pointer]:
      - generic [ref=e254]: Gibraltar
    - listitem [ref=e255] [cursor=pointer]:
      - generic [ref=e256]: Honduras
    - listitem [ref=e257] [cursor=pointer]:
      - generic [ref=e258]: Iran (Islamic Republic of)
    - listitem [ref=e259] [cursor=pointer]:
      - generic [ref=e260]: Iraq
    - listitem [ref=e261] [cursor=pointer]:
      - generic [ref=e262]: Israel
    - listitem [ref=e263] [cursor=pointer]:
      - generic [ref=e264]: Korea, Democratic People's Republic of
    - listitem [ref=e265] [cursor=pointer]:
      - generic [ref=e266]: Lao, People's Democratic Republic
    - listitem [ref=e267] [cursor=pointer]:
      - generic [ref=e268]: Libyan Arab Jamahiriya
    - listitem [ref=e269] [cursor=pointer]:
      - generic [ref=e270]: Micronesia, Federated States of
    - listitem [ref=e271] [cursor=pointer]:
      - generic [ref=e272]: Montserrat
    - listitem [ref=e273] [cursor=pointer]:
      - generic [ref=e274]: Nicaragua
    - listitem [ref=e275] [cursor=pointer]:
      - generic [ref=e276]: Paraguay
    - listitem [ref=e277] [cursor=pointer]:
      - generic [ref=e278]: Russian Federation
    - listitem [ref=e279] [cursor=pointer]:
      - generic [ref=e280]: Saudi Arabia
    - listitem [ref=e281] [cursor=pointer]:
      - generic [ref=e282]: Sierra Leone
    - listitem [ref=e283] [cursor=pointer]:
      - generic [ref=e284]: Syrian Arab Republic
    - listitem [ref=e285] [cursor=pointer]:
      - generic [ref=e286]: Ukraine
    - listitem [ref=e287] [cursor=pointer]:
      - generic [ref=e288]: United Arab Emirates
    - listitem [ref=e289] [cursor=pointer]:
      - generic [ref=e290]: Western Sahara
  - status [ref=e291]:
    - generic [ref=e292]: 27 results are available, use up and down arrow keys to navigate.
```
...
```ts
  ...
  6  | 
  7  |     await page.locator('input#autocomplete').fill('ra');
  8  | 
> 9  |     await page.waitForSelector('//li[@clas]/div');
     |                ^ Error: page.waitForSelector: Test timeout of 30000ms exceeded.
  10 | 
  11 |     const countryOptions = await page.$$('//li[@class="ui-menu-item"]/div');
  12 | 
  13 |     for (let option of countryOptions) {
  14 |         const value = await option.textContent();
  15 |         console.log(value);
  16 |         if (value.includes('Australia')) {
