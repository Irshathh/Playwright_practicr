...
- Name: radioButton.spec.js >> radio button
- Location: tests\radioButton.spec.js:24:5
...
```ts
  ...
  14 | //     await expect(await page.locator('[value="radio2"]').isChecked()).toBeFalsy();
  15 | 
  ...
  29 |     //Radio Button
  30 | 
  31 |    // await expect (page.locator('[value="radio1"]')).check();
  32 |      await page.check('[value="radio1"]');
  33 | 
  34 | 
  35 |     await expect(page.locator('[value="radio1"]')).toBeChecked();
  36 |     await expect(page.locator('[value="radio1"]').isChecked()).toBeTruthy();
  37 | 
  38 |     // Unchecked radio button
  39 | 
> 40 |     await expect(page.locator('[value="radio2"]').isChecked()).toBeFalsy();
     |                                                                ^ Error: expect(received).toBeFalsy()
  41 | 
