...
- Name: autoSuggest.spec.js >> Auto suggest
- Location: tests\autoSuggest.spec.js:35:5
...
- generic [ref=e1]:
  ...
  - generic [ref=e12]:
    ...
    - group "Suggession Class Example" [ref=e23]:
      ...
      - textbox "Type to Select Countries" [active] [ref=e25]: in
  ...
  - list [ref=e236]:
    - listitem [ref=e237] [cursor=pointer]:
      - generic [ref=e238]: Argentina
    - listitem [ref=e239] [cursor=pointer]:
      - generic [ref=e240]: Bahrain
    - listitem [ref=e241] [cursor=pointer]:
      - generic [ref=e242]: Benin
    - listitem [ref=e243] [cursor=pointer]:
      - generic [ref=e244]: Bosnia and Herzegowina
    - listitem [ref=e245] [cursor=pointer]:
      - generic [ref=e246]: British Indian Ocean Territory
    - listitem [ref=e247] [cursor=pointer]:
      - generic [ref=e248]: Burkina Faso
    - listitem [ref=e249] [cursor=pointer]:
      - generic [ref=e250]: China
    - listitem [ref=e251] [cursor=pointer]:
      - generic [ref=e252]: Cocos (Keeling) Islands
    - listitem [ref=e253] [cursor=pointer]:
      - generic [ref=e254]: Dominica
    - listitem [ref=e255] [cursor=pointer]:
      - generic [ref=e256]: Dominican Republic
    - listitem [ref=e257] [cursor=pointer]:
      - generic [ref=e258]: Equatorial Guinea
    - listitem [ref=e259] [cursor=pointer]:
      - generic [ref=e260]: Falkland Islands (Malvinas)
    - listitem [ref=e261] [cursor=pointer]:
      - generic [ref=e262]: Finland
    - listitem [ref=e263] [cursor=pointer]:
      - generic [ref=e264]: Guinea
    - listitem [ref=e265] [cursor=pointer]:
      - generic [ref=e266]: Guinea-Bissau
    - listitem [ref=e267] [cursor=pointer]:
      - generic [ref=e268]: India
    - listitem [ref=e269] [cursor=pointer]:
      - generic [ref=e270]: Indonesia
    - listitem [ref=e271] [cursor=pointer]:
      - generic [ref=e272]: Liechtenstein
    - listitem [ref=e273] [cursor=pointer]:
      - generic [ref=e274]: Martinique
    - listitem [ref=e275] [cursor=pointer]:
      - generic [ref=e276]: Papua New Guinea
    - listitem [ref=e277] [cursor=pointer]:
      - generic [ref=e278]: Philippines
    - listitem [ref=e279] [cursor=pointer]:
      - generic [ref=e280]: Saint Kitts and Nevis
    - listitem [ref=e281] [cursor=pointer]:
      - generic [ref=e282]: Saint Lucia
    - listitem [ref=e283] [cursor=pointer]:
      - generic [ref=e284]: Saint Vincent and the Grenadines
    - listitem [ref=e285] [cursor=pointer]:
      - generic [ref=e286]: San Marino
    - listitem [ref=e287] [cursor=pointer]:
      - generic [ref=e288]: Sao Tome and Principe
    - listitem [ref=e289] [cursor=pointer]:
      - generic [ref=e290]: Singapore
    - listitem [ref=e291] [cursor=pointer]:
      - generic [ref=e292]: Spain
    - listitem [ref=e293] [cursor=pointer]:
      - generic [ref=e294]: Suriname
    - listitem [ref=e295] [cursor=pointer]:
      - generic [ref=e296]: Taiwan, Province of China
    - listitem [ref=e297] [cursor=pointer]:
      - generic [ref=e298]: Trinidad and Tobago
    - listitem [ref=e299] [cursor=pointer]:
      - generic [ref=e300]: Ukraine
    - listitem [ref=e301] [cursor=pointer]:
      - generic [ref=e302]: United Kingdom (UK)
    - listitem [ref=e303] [cursor=pointer]:
      - generic [ref=e304]: United States Minor Outlying Islands
    - listitem [ref=e305] [cursor=pointer]:
      - generic [ref=e306]: Virgin Islands (British)
    - listitem [ref=e307] [cursor=pointer]:
      - generic [ref=e308]: Virgin Islands (U.S.)
  - status [ref=e309]:
    - generic [ref=e310]: 36 results are available, use up and down arrow keys to navigate.
```
...
```ts
  ...
  5  | 
  6  | // test('Auto Suggest Dropdown', async ({ page }) => {
  7  | 
  8  | //     await page.goto('https://rahulshettyacademy.com/AutomationPractice/');
  9  | 
  10 | //     await page.locator('input#autocomplete').fill('ar');
  11 | 
  12 | //     await page.waitForSelector('//li[@class="ui-menu-item"]//div');
  13 | 
  14 | //     const CountryOption = await page.$$('//li[@class="ui-menu-item"]//div');
  15 | 
  16 | //     for (let option of CountryOption){
  17 | 
  18 | //         const value = await option.textContent();
  19 | //         console.log(value);
  20 | //         if(value.includes('Qatar')){
  21 | //             await option.click();
  22 | //             break;
  23 | //         }
  24 | 
  25 | 
  ...
  35 | test('Auto suggest', async({page})=>{
  36 | 
  37 |     await page.goto('https://rahulshettyacademy.com/AutomationPractice/');
  38 | 
  39 |     await page.locator('input#autocomplete').fill('in');
  40 | 
  41 |     await page.waitForSelector('//li[@class="ui-menu-item"]//div');
  42 | 
  43 |     const CountryOptions = await page.$$('//li[@class="ui-menu-item"]//div');
  44 | 
  45 |     for (let option of CountryOptions){
  46 |         const value = await option.textContent();
  47 |         console.log(value);
  48 |         if (value.includes('Finland')){
