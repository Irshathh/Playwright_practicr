...
```ts
  ...
  29 |     await expect(page.locator('[value="radio1"]').isChecked()).toBeTruthy();
  30 | 
  31 | 
  32 |     //Checking the Unchecked radio Buttons
  33 | 
> 34 |     await expect(page.locator('[value="radio2"]').isChecked()).toBeFalsy();
     |                                                                ^ Error: expect(received).toBeFalsy()
  35 | 
  36 | 
